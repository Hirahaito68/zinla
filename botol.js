...
//MESS
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			botol.sendMessage(from, teks, text, { thumbnail: thumb, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `New Base By KubilBot`,body:"© Creator By KubilBot",previewType:"PHOTO",thumbnail:thumb,sourceUrl:`https://youtube.com/c/BotolBotZ`}}})
		}
		const reply2 = (teks) => {
...
const fbotol = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `© Creator By KubilBot`,
                 "title": `© Creator By KubilBot`,
